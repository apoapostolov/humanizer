...
| release_tag | `v3.26.0` |
| release_url | `https://github.com/conorbronsdon/avoid-ai-writing/releases/tag/v3.26.0` |
| last_ingested_version | `3.26.0 (40328bd)` |
| last_ingested_ref | `40328bd292bc` |
| last_ingested_at | `2026-08-24T02:50:00-07:00` |
| last_checked_at | `2026-08-24T02:50:00-07:00` |
| compare_base | `v3.26.0` |
...
| next_check | On newer tag than `v3.26.0`, or untagged commits on default branch after `40328bd` if the user wants tip tracking. |
...
| last_ingested_version | `2.11.1+tip (e2e92e7)` |
| last_ingested_ref | `e2e92e7b4b82` |
| last_ingested_at | `2026-08-21T13:45:00-07:00` |
...
| next_check | On newer tag than `v2.11.1` (tip `e2e92e7` documents an unreleased `2.11.2`: plugin-symlink removal + README packaging rework, no change to the 35 patterns), or untagged commits on default branch after `last_ingested_ref` if the user wants tip tracking. |

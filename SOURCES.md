...
| last_sources_sync | `2026-09-19T00:00:00+03:00` |
...
| release_tag | `v3.35.0` (tip `7a2c7d1` ingested untagged) |
| release_url | `https://github.com/conorbronsdon/avoid-ai-writing/releases/tag/v3.35.0` |
| last_ingested_version | `3.35.0` + tip `7a2c7d1` (engine delta absorbed into ai-writing-detector) |
| last_ingested_ref | `7a2c7d11d4a7` |
| last_ingested_at | `2026-09-19T00:00:00+03:00` |
| last_checked_at | `2026-09-19T00:00:00+03:00` |
| compare_base | `7a2c7d1` |
...
| next_check | On newer tag than `v3.35.0`, or untagged commits on default branch after `7a2c7d1`. |
